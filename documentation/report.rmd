...
cpue_IBTS <- within(cpue_IBTS, haulCode <-  paste(Year, Survey, Quarter, Ship, HaulNo, ShootLat, ShootLong, sep="_"))
```
...
#make haul code
cpue_BTS <- within(cpue_BTS, haulCode <- paste(Year, Survey, Quarter, Ship, HaulNo, ShootLat, ShootLong, sep="_"))
```
...
HH_IBTS <- within(HH_IBTS, haulCode <-  paste(Year, Survey, Quarter, Ship, HaulNo, ShootLat, ShootLong, sep="_"))
...
```{r, eval=T, echo=T}
HH_IBTS <- HH_IBTS[names(HH_IBTS) %in% c("haulCode", "surface", "HaulDur","Doorspread","Ditance","Netopening","Warplngt")]
