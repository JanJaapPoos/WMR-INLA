...
Finally, we store the survey data (which still has a count per haul per length). this data will be used in the INLA examples

```{r, eval=T, echo=TRUE}
save(full_cpue,file=file.path(path,"survey_data.Rdata"))
```
